...
exports.default = validateThrottleHelperEffect;
...
function validateThrottleHelperEffect(eventChannel, effectName, actual, expected, stepNumber) {
  ...
  var expectedForkFn = _expectedFork$FORK.fn;
  var expectedForkArgs = _expectedFork$FORK.args;
  var _actualFork$FORK = actualFork[_keys.FORK];
  var actualForkFn = _actualFork$FORK.fn;
  var actualForkArgs = _actualFork$FORK.args;
  ...
  var expectedDelay = _expectedCall$CALL$ar[0];
  var _actualCall$CALL$args = actualCall[_keys.CALL].args;
  var actualDelay = _actualCall$CALL$args[0];
